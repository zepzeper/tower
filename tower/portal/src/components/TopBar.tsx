    ...
    <header className={`${theme === 'light' ? 'bg-white border-b border-gray-200' : 'bg-gray-900 border-b border-gray-700'} h-16 flex items-center px-6 transition-colors duration-200`}>
      ...
      <div className="relative flex-1 max-w-xs">
        ...
        <input
          ...
          className={`block w-full rounded-md border-0 py-2 pl-10 ${theme === 'light'
      ...
      <div className="ml-auto flex items-center space-x-4">
        ...
        <div className="relative">
          ...
          {showDropdown && (
            <div className={`absolute right-0 mt-2 w-40 ${theme === 'light'
        ...
        <div className="relative">
          ...
          {showDropdown && (
            <div className={`absolute right-0 mt-2 w-48 ${theme === 'light'
              ? 'bg-white ring-1 ring-black ring-opacity-5'
              : 'bg-gray-800 ring-1 ring-gray-700'
              } rounded-md shadow-lg py-1 z-10`}
            >
